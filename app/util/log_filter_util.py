...
class LogFilterUtil:
    @staticmethod
    def _get_date_time_in_comparable_format(date_time_as_string: str, format: str = '%d/%b/%Y:%H:%M:%S'):
    ...
    def get_logs_within_timeframe(logs_to_filter: List[str], time_range: TimeRangeDto):
        ...
        start_time = LogFilterUtil._get_date_time_in_comparable_format(time_range.start_time)
